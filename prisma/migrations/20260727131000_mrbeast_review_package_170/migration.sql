...
VALUES
('obs_src_mb17_bitmine_10q','https://www.sec.gov/Archives/edgar/data/1829311/000149315226016560/form10-q.htm','BitMine Form 10-Q Note 6 Investments for quarter ended February 28 2026','BitMine Immersion Technologies / SEC','official_sec_financial_statement','2026-04-13T00:00:00Z','2026-07-26T00:00:00Z',true,'public',CURRENT_TIMESTAMP),
('obs_src_mb17_bitmine_r15','https://www.sec.gov/Archives/edgar/data/1829311/000149315226016560/R15.htm','BitMine structured Note 6 Investments','BitMine Immersion Technologies / SEC','official_sec_xbrl_note','2026-04-13T00:00:00Z','2026-07-26T00:00:00Z',true,'public',CURRENT_TIMESTAMP),
...
VALUES
('obs_ev_mb17_c38','obs_claim_mb17_c38','obs_src_mb17_bitmine_10q','supports',NULL,'Note 6 lines describing Series C and secondary common purchases','Dollar figures presented in thousands; approximately $180 million total cash consideration.',CURRENT_TIMESTAMP),
('obs_ev_mb17_c39','obs_claim_mb17_c39','obs_src_mb17_bitmine_10q','supports',NULL,'Note 6 transaction costs carrying amount and impairment statement','Accounting measures are date-specific and distinct from current fair value.',CURRENT_TIMESTAMP),
...
('obs_ev_mb17_c41','obs_claim_mb17_c41','obs_src_mb17_bitmine_10q','supports',NULL,'Note 6 side-letter status as of February 28 2026','Prospectively corrects the unsupported May 31 endpoint in immutable 1.1.0.',CURRENT_TIMESTAMP)
...
VALUES
('obs_rel_mb17_bitmine_accounting_measures',(SELECT "id" FROM "ObservatoryCase" WHERE "slug"='mrbeast' LIMIT 1),'organization','BitMine Immersion Technologies','outside_minority_investor_with_date_specific_accounting_measures','2026-01-15T00:00:00Z',NULL,'unreviewed','draft','obs_src_mb17_bitmine_10q',NULL,'Approximately $180 million cash consideration plus $6.024 million capitalized transaction costs; no personal-economics inference',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP)
ON CONFLICT ("id") DO NOTHING;
