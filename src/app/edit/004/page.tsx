...
export default function EditionFourPage() {
  return <main className="edit-edition-page">
    ...
    <section className="closing-call"><p className="eyebrow">The I/1 Edit</p><h2>Follow the research on work, ownership, continuity, and institutional power.</h2><NewsletterSignup source="edit-004" /></section>
  </main>;
}
