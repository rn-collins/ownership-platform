...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return <html lang="en"><body><div className="site-shell">
    <header className="site-header"><a className="brand" href="/" aria-label="Institutions of One home"><span className="brand-mark">I/1</span><span className="brand-name">Institutions<br/>of One</span></a><nav className="nav" aria-label="Primary">
      <a href="/methodology">The idea</a><a href="/observatory">People</a><a href="/observatory/apply">Apply</a><a href="/observatory/dependencies">Dependencies</a><a href="/observatory/countercases">Countercases</a><a href="/observatory/timeline">Timeline</a><a href="/observatory/evidence">Evidence</a><a href="/observatory/findings">Living findings</a><a href="/observatory/teaching">Teach</a><a href="/observatory/resources">Resources</a><a href="/assess">Measure</a><a href="/edit">Read</a><a href="/partner">Work with us</a>{user ? <><a href="/dashboard">Dashboard</a><form action="/auth/signout" method="post"><button type="submit" className="navlink">Sign out</button></form></> : <a className="nav-signin" href="/login">Sign in</a>}
    </nav></header>
    ...
    <footer className="foot"><div className="foot-statement">What happens when the person is no longer just the talent—but the infrastructure?</div><div className="foot-cols">
      <div className="foot-col"><span className="foot-h">Explore</span><a href="/methodology">The idea and method</a><a href="/assess">Pilot assessments</a><a href="/observatory">The Observatory</a><a href="/observatory/apply">Apply the cases to your work</a><a href="/observatory/dependencies">Explore dependencies</a><a href="/observatory/countercases">Find a countercase</a><a href="/observatory/timeline">Trace structural transitions</a><a href="/observatory/evidence">Explore the evidence</a><a href="/observatory/findings">Watch living findings</a><a href="/observatory/teaching">Use teaching mode</a><a href="/observatory/resources">Build case resources</a><a href="/findings">Research and findings</a></div>
