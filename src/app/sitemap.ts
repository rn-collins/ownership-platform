...
export default function sitemap(): MetadataRoute.Sitemap {
  const publicRoutes = [
    "", "/methodology", "/methodology/candidates", "/assess", "/assess/creator", "/assess/professional", "/observatory", "/observatory/apply", "/observatory/dependencies", "/observatory/countercases", "/observatory/timeline", "/observatory/evidence", "/findings", "/edit", "/edit/001", "/edit/002", "/partner", "/about", "/research/cognitive-interviews", "/privacy",
  ];
  return [
