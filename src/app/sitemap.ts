...
export default function sitemap(): MetadataRoute.Sitemap {
  const publicRoutes = [
    "", "/methodology", "/methodology/candidates", "/assess", "/assess/creator", "/assess/professional", "/observatory", "/observatory/apply", "/observatory/dependencies", "/observatory/countercases", "/observatory/evidence", "/observatory/documentation", "/edit", "/edit/001", "/edit/002", "/edit/003", "/edit/004", "/edit/005", "/edit/006", "/edit/007", "/edit/008", "/partner", "/about", "/research/cognitive-interviews", "/privacy",
  ];
  return [
