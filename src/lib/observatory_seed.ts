...
export const SEED: Node[] = [
  ...
  { name: "Gordon Glenister", role: "Founder of the BCMA’s influencer-marketing division", domain: "Creator Economy", kind: "professional", created: true },
  { name: "Claire Zau", role: "Creator and investor at Lightspeed", domain: "Venture", kind: "professional", created: true },
  ...
  { name: "Charlotte Tansill", role: "President of social, creator, and earned media at Publicis", domain: "Agency", kind: "professional", created: true },
  { name: "Kunal Shah", role: "Founder of CRED and technology executive", domain: "Tech", kind: "professional", created: true },
  ...
  { name: "Peter Diamandis", role: "Engineer, physician, and founder of XPRIZE", domain: "Science", kind: "professional" },
  { name: "Noubar Afeyan", role: "Inventor, entrepreneur, and founder of Flagship Pioneering", domain: "Science", kind: "professional" },
  { name: "Nadir Godrej", role: "Business leader, scientist, and poet", domain: "Business", kind: "professional" },
  ...
  { name: "Marques Brownlee", role: "Technology creator and studio founder", domain: "Tech", kind: "creator" },
  ...
  { name: "Colin & Samir", role: "Independent creator-economy media company", domain: "Creator Economy", kind: "creator" },
  { name: "Alex Cooper", role: "Founder and CEO of Unwell Network", domain: "Media", kind: "creator" },
  { name: "Codie Sanchez", role: "Founder of Contrarian Thinking and business investor", domain: "Finance", kind: "creator" },
  ...
  { name: "Cathy Hackl", role: "Technology futurist and metaverse executive", domain: "AI", kind: "professional", created: true },
  ...
  { name: "Astro Teller", role: "CEO of X, known as Captain of Moonshots", domain: "Tech", kind: "professional", created: true },
  ...
  { name: "Simon Cook", role: "CEO of Cannes Lions", domain: "Agency", kind: "professional" },
  ...
  { name: "Reid Hoffman", role: "Founder, venture investor, author, and podcast host", domain: "Venture", kind: "professional" },
  { name: "Fei-Fei Li", role: "AI scientist, World Labs founder, and author", domain: "AI", kind: "professional" },
  { name: "Neri Oxman", role: "Designer, materials researcher, and founder of OXMAN", domain: "Design", kind: "professional" },
  { name: "Brian May", role: "Musician, astrophysicist, and publisher", domain: "Science", kind: "professional" },
];
