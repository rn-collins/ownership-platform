...
export const SEED: Node[] = [
  ...
  { name: "Ashley Rudder", role: "Chief Creator Officer at Deutsch New York, previously at Whalar", domain: "Creator Economy", kind: "professional", created: true, tension: "Role vs person", question: "Is a chief creator officer a real transfer of power—or a new title for old marketing work?" },
  ...
  { name: "Jane Gilbert", role: "Chief Heat Ambassador at the Climate Resilience Center; the world’s first Chief Heat Officer, for Miami-Dade County", domain: "Government", kind: "professional", created: true, tension: "Public mandate vs personal authority", question: "How can one coordinator create institutional consequence without personally owning the system?" },
